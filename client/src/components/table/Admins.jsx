...
const TableAdmins = ({title, data}) => {
    ...
    const filteredDataAdmin = filteredData.filter(data => data.role === "admin")

    const indexOfLastData = currentPage * dataPerPage
    const indexOfFirstData = indexOfLastData - dataPerPage
    const currentData = filteredDataAdmin.slice(indexOfFirstData, indexOfLastData)
    ...
    const paginateFront = () => {
        const remainingData = filteredDataAdmin.length - indexOfLastData;
        if (remainingData > 0) {
                        ...
                        <tr key={index}>
                            ...
                            <td>
                                <div className="h-full flex justify-center items-center gap-4">
                                   <Link to={`/edit-admin/${currData.id}`} disabled>
                        ...
                        <tr>
                            <th colSpan={8}>
                                <Pagination
                                    ...
                                    totalData={filteredDataAdmin.length}
