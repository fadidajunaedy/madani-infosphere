            ...
            <div className="flex justify-between items-center my-2">
                ...
                <div className="flex justify-center items-center gap-4">
                    ...
                    {(
                        ...
                        (userData.position === "HRGA" && (subcategory === "weekly-update" || subcategory === "sop-hrga" || subcategory === "catatan-rapat")) || 
                        (userData.position === "Finance" && (subcategory === "sop-keuangan" || subcategory === "catatan-rapat")) || 
                        (userData.position === "Comms" && (subcategory === "sop-komunikasi" || subcategory === "siaran-pers" || subcategory === "infografik" || subcategory === "media-monitoring"  || subcategory === "catatan-rapat" || subcategory === "asset-digital" || subcategory === "laporan-sosmed")) ||
                        ((userData.position === "Program Manager" || userData.position === "Biofuel" || userData.position === "Klima" || userData.position === "Green Development" || userData.position === "Komodo") && (subcategory === "hutan-dan-iklim" || subcategory === "komoditas-berkelanjutan" || subcategory === "pembangunan-hijau" || subcategory === "bioenergi" || subcategory === "publikasi-internal" || subcategory === "materi-literasi" || subcategory === "peraturan-dan-regulasi" || subcategory === "db-tabular" || subcategory === "db-spasial" || subcategory === "catatan-rapat")) ||
                        (userData.position === "Knowledge Management" && (subcategory === "rencana-strategis" || subcategory === "publikasi-internal" || subcategory === "materi-literasi" || subcategory === "peraturan-dan-regulasi" || subcategory === "db-tabular" || subcategory === "db-spasial" || subcategory === "media-monitoring" || subcategory === "catatan-rapat"))
                    ) && (  
