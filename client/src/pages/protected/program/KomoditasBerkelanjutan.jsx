...
const KomoditasBerkelanjutan = () => {
    ...
    return (
        <>
            ...
            <ModalConfirm />
            <ProgramLink />
            <Reports title={"Komoditas Berkelanjutan"} data={data} category="program" subcategory="komoditas-berkelanjutan"/>
        </>
    )
}

export default KomoditasBerkelanjutan