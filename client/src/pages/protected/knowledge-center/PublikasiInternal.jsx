...
const PublikasiInternal = () => {
    ...
    return (
        <>
            <Modal />
            <ModalConfirm />
            <Reports title="Publikasi Internal" data={data} category="knowledge-center" subcategory="publikasi-internal"/>
        </>
    )
}

export default PublikasiInternal