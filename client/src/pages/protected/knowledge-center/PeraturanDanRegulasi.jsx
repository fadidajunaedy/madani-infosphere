...
const PeraturanDanRegulasi = () => {
    ...
    return (
        <>
            <Modal />
            <ModalConfirm />
            <Reports title="Peraturan dan Regulasi" data={data} category="knowledge-center" subcategory="peraturan-dan-regulasi"/>
        </>
    )
}

export default PeraturanDanRegulasi